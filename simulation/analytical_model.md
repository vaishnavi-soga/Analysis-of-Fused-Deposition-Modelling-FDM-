...
Before running numerical simulations in ANSYS, it is valuable to understand the **governing physics** through an analytical model. The Yardimci model describes the heat transfer in a single FDM filament during deposition and forms the theoretical foundation for this project's simulations.
